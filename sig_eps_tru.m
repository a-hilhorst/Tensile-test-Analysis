function [sigma,epsilon] = SigEpsTru(sigma_eng,epsilon_eng,maxInd,fRange)
% SIGEPSTRU(F,u,A0,L0) returns the true stress sigma in [MPa] and
% true epsilon in [-] from the engineering stress sigma_eng in [MPa] and 
% the engineering strain espilon_eng in [%].
%
% see also SigEpsEng, youngModulus, yieldStrength.
